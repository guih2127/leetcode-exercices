...
public class MergeSortedArray
{
    ...
    private static void GoodSolution(int[] nums1, int m, int[] nums2, int n)
    {
        ...
        var firstPointer = m - 1; // end of first array (not including zeros)
        var secondPointer = n - 1; // end of second array
        var thirdPointer = m + n - 1; // end of first array (including zeros)
        ...
        // We also decrease the pointer for the array that has the higher number, because this element is already on the end of the nums1 array.
